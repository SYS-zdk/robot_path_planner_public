 ...
 *
 * @file: optimizer.h
 * @breif: Trajectory optimization //Optimizer 的抽象基类，用于轨迹优化。它提供了一些基本的接口和方法，用于实现具体的轨迹优化算法
 * @author: REMOVED
 * @update: 2023-12-29
 * @version: 1.0
 *
 * Copyright (c) 2023, REMOVED
 * All rights reserved.
 * --------------------------------------------------------
 *
 **********************************************************/
#ifndef RPP_TRAJECTORY_OPTIMIZATION_OPTIMIZER_H_
#define RPP_TRAJECTORY_OPTIMIZATION_OPTIMIZER_H_
