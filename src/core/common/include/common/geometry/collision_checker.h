 ...
 *
 **********************************************************/
#ifndef RPP_COMMON_GEOMETRY_COLLISION_CHECKER_H_
#define RPP_COMMON_GEOMETRY_COLLISION_CHECKER_H_
...
{
public:
  CollisionChecker(costmap_2d::Costmap2DROS* costmap_ros, double factor = 0.5)
    : costmap_ros_(costmap_ros), factor_(factor){};
