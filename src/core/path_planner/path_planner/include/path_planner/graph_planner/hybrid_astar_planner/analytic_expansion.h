...
public:
   ...
   */
  void setCollisionChecker(const std::shared_ptr<rpp::common::geometry::CollisionChecker>& collision_checker);
...
protected:
  ...
  std::shared_ptr<rpp::common::geometry::CollisionChecker> collision_checker_;
